...
def cmd_setup_app(_args) -> int:
    from .core.command import install_app_launcher

    targets = install_app_launcher()
    print("Installed Dwine app launcher(s):")
    for target in targets:
        print(f"  → {target}")
    print("Open Dwine from your app menu, Start Menu, Applications folder, or desktop.")
    return 0
...
def build_parser() -> argparse.ArgumentParser:
    ...
    sub.add_parser("setup-app", help="install a clickable Dwine desktop app launcher")
    return parser
