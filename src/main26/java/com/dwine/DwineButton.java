...
/** Dwine-styled button: dark glass card, violet accent, hover lift and compact text. */
public final class DwineButton extends Button {
    ...
    protected void extractWidgetRenderState(GuiGraphicsExtractor graphics, int mouseX, int mouseY, float delta) {
        ...
        graphics.centeredText(MinecraftHolder.font(), getMessage(), x + this.width / 2 + (compact ? 1 : 0), textY, color, false);
    }

    /** Avoid threading Minecraft through every tiny widget constructor. */
